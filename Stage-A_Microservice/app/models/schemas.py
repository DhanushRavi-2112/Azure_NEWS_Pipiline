...
class RealCompetitorData(BaseModel):
    ...
    serp_positions: Dict[str, Union[int, str]] = Field(description="Current ranking positions for target keywords (real data or estimates)")
    actual_search_volume: Dict[str, Union[int, str]] = Field(description="Real monthly search volume for keywords (real data or estimates)")
    competitor_backlinks: Dict[str, Union[int, str]] = Field(description="Actual backlink counts for competing URLs (real data or estimates)")
    social_shares: Dict[str, Dict[str, Union[int, str]]] = Field(description="Real social media shares by platform (real data or estimates)")
    content_length_comparison: Dict[str, Union[int, str]] = Field(description="Word count of competing articles (real data or estimates)")
    publish_date_analysis: Dict[str, str] = Field(description="Freshness comparison with competitors")
    domain_authority_scores: Dict[str, Union[int, str]] = Field(description="Domain authority of competing sites (real data or estimates)")
